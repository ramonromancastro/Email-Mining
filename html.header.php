    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img class="pull-left" title="[Logo]" alt="[Logo]" src="images/logo.png"/><span class="pull-left name">Email Mining <span class="small">v<?php echo APPVERSION; ?></span></a>
        </div>
        <!--
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="?p=overview.php">Vistazo</a></li>
